...
OUTPUT_ROOT = Path("analysis/modeling/lightgbm_resume_by_model")
TRAIN_SCRIPT = Path("analysis/train_lightgbm_resume.py")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train one LightGBM resume model per LLM model."
    )
    ...
    # Forwarded options for analysis/train_lightgbm_resume.py
    ...
    parser.add_argument("--cv-verbose-eval", type=int, default=0)
...
def build_train_command(
    ...
    cmd = [
        ...
        "--bagging-fraction",
        str(args.bagging_fraction),
        "--bagging-freq",
        str(args.bagging_freq),
