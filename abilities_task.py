...
app = typer.Typer(add_completion=False, help="Run ability vocabulary experiments.")
...
def run(
    ...
    """Execute the ability vocabulary pipeline."""
    load_dotenv()
    ...
    executor = TaskExecutor(TaskType.ABILITIES, defaults, models)
...
# python subjects_task.py --model qwen --model-version qwen3-32b --debug              
